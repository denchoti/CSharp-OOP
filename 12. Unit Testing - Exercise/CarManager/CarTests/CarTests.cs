...
namespace Tests
{
    public class CarTests
    {
        ...
        [Test]
        public void Ctor_SetInitialValue_WhenArgumentsAreValid()
        {
            string make = "Make";
            string model = "Model";
        ...
        [TestCase(0)]
        [TestCase(-20)]
        public void Refuel_ThroesException_WhenFuelIsZeroOrNegative(double fuel)
        {
        ...
        public void Drive_DecreasesFuelAmount_WhenDistanceIsValid()
        {
            ...
            car.Drive(100);
            Assert.That(car.FuelAmount, Is.LessThan(initialFuel));
