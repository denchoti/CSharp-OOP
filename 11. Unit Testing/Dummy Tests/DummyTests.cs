...
public class DummyTests
{
    ...
    [Test]
    public void When_AttackIsFealth_ShouldDecreaseHealth()
    {
        int attackPoints = 3;
    ...
    [Test]
    public void When_AttckDummyIsDead_ShouldThrow()
    {
    ...
    [Test]
    public void When_HealthIsPostive_ShouldBeAlive()
    {
    ...
    public void When_HealthIsZNegative_ShouldBeDead()
    {
    ...
    [Test]
    public void When_AliveGivesExperience_ShouldThrow()
    {
